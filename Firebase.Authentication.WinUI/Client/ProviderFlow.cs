...
using Firebase.Authentication.WinUI.Internal;
using Microsoft.Extensions.Logging;
using Microsoft.UI.Xaml;
using Microsoft.UI.Xaml.Controls;
using Microsoft.Web.WebView2.Core;

namespace Firebase.Authentication.WinUI.Client;
...
public abstract class ProviderFlow : IProviderFlow
{
    ...
    void CreateWindowAndWebView()
    {
        ...
        windowHelper.SetSize(windowSize.width, windowSize.height);
        windowHelper.SetPosition(WindowConfiguration.StartupLocation, WindowConfiguration.Left, WindowConfiguration.Top, WindowConfiguration.Owner);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        window.Activate();
        if (WindowConfiguration.ShowAsDialog && WindowConfiguration.Owner is not null)
            windowHelper.MakeDialog(WindowConfiguration.Owner);
