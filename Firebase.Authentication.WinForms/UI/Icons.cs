...
public static class Icons
{
    ...
    /// <param name="canvasWidth">The canvas width of the drawn bitmap</param>
    /// <param name="canvasHeight">The canvas height of the drawn bitmap</param>
        ...
        int canvasHeight = 128)
    {
        ...
        Bitmap image = new(canvasWidth, canvasHeight);
