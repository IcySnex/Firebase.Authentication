...
namespace Firebase.Authentication.WinForms.Configuration;

/// <summary>
/// Configuration for a provider flow form
/// </summary>
public class FormConfig
{
    ...
    /// <param name="parent">The parent of this form. (Only used for StartPosition.CenterParent)</param>
    ...
    /// (Only used for StartPosition.CenterParent)
    /// </summary>
