...
public class Navigation
{
        ...
        StringComparison comparision = StringComparison.InvariantCultureIgnoreCase)
    {
        try
        {
            ...
            return items.Find(item => searchFor?.Equals(searchForContent ? $"Firebase.Authentication.Sample.UWP.Views.{item.Content}View" : item.Content.ToString(), comparision) ?? false);
        }
        catch { return null; }
    }
